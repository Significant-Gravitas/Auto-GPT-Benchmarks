...
3. `auto-gpt-benchmarks start --challenge challenge_category` remove challenge flag to run all tests. specify config of hostname, port, and workspace directory
