...
class AutoGPTAgent:
    ...
    def __init__(self, prompt):
        ...
        self.auto_workspace.mkdir(exist_ok=True)  # ADDED this line to make sure auto_gpt_workspace folder exists
        ...
        self._copy_prompt()  #Added this too need to copy prompt
        self._copy_ai_settings() #ADDED IT TO COPY AI_SETTING.YAML TO SUBMODULE Auto-GPT workspace
